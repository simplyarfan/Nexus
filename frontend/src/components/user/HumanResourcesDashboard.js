  ...
  const agents = [
    {
      ...
      description: 'Manage new employee onboarding with automated checklists, email sequences, and progress tracking.',
      href: '/hr/onboarding',
      icon: (
    ...
    },
    {
      ...
      description: 'View and manage all employee profiles, salaries, departments, and more.',
      href: '/hr/employees',
      icon: (
        <svg className="w-8 h-8" fill="none" viewBox="0 0 24 24" stroke="currentColor">
        ...
        <div className="p-4 border-t border-sidebar-border relative">
          ...
          >
            ...
            <div className="flex-1 text-left">
              ...
              <p className="text-xs text-muted-foreground">{user?.department || 'Human Resources'}</p>
            </div>
            <svg
            ...
            <div className="max-w-7xl mx-auto px-8 py-8">
              <div className="flex items-center justify-between">
                <div className="flex items-center gap-4 flex-1">
                  ...
                  >
                    <h1 className="text-4xl font-bold text-foreground mb-2">Human Resources Dashboard</h1>
                    <p className="text-muted-foreground text-lg">
                      Welcome back! Manage your AI-powered HR tools
                    </p>
                  </motion.div>
                </div>
          ...
          <div className="max-w-7xl mx-auto px-8 py-8">
            <div className="mb-6">
              ...
              <p className="text-muted-foreground">
                Launch intelligent agents to automate your HR workflow
              </p>
            </div>
            ...
            {agents.length === 0 ? (
              <motion.div
                ...
                className="bg-card border-2 border-dashed border-border rounded-2xl p-12 text-center"
              >
                ...
                <p className="text-muted-foreground max-w-md mx-auto">
                  AI-powered HR tools are being developed. Check back soon for employee management,
                  performance tracking, and more intelligent automation features.
                </p>
              </motion.div>
            ) : (
