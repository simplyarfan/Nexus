  ...
  const agents = [
    {
      ...
      description: 'AI-powered email composition and templates for sales outreach',
      href: '/email-composer',
    },
    {
      icon: (
      ...
      title: 'Lead Analyzer',
      description: 'Analyze and score potential leads with intelligent insights',
      href: '/lead-analyzer',
    },
  ];
        ...
        <div className="p-4 border-t border-sidebar-border relative">
          ...
          >
            ...
            <div className="flex-1 text-left">
              ...
              <p className="text-xs text-muted-foreground">{user?.department || 'Sales & Marketing'}</p>
            </div>
            <svg
            ...
            <div className="max-w-7xl mx-auto px-8 py-8">
              <div className="flex items-center justify-between">
                <div className="flex items-center gap-4 flex-1">
                  ...
                  >
                    <h1 className="text-4xl font-bold text-foreground mb-2">Sales & Marketing Dashboard</h1>
                    <p className="text-muted-foreground text-lg">
                      Welcome back! Manage your AI-powered sales tools
                    </p>
                  </motion.div>
                </div>
          ...
          <div className="max-w-7xl mx-auto px-8 py-8">
            <div className="mb-6">
              ...
              <p className="text-muted-foreground">
                Launch intelligent agents to automate your sales workflow
              </p>
            </div>
