      ...
      candidates: [
        {
          ...
          professionalAssessment:
            'Outstanding product leadership with proven track record of launching successful products. Strong strategic thinking and cross-functional collaboration skills. Excellent at balancing user needs with business objectives.',
        },
      ],
    },
    {
              ...
              <div className="max-w-4xl mx-auto">
                ...
                <div className="space-y-6">
                  ...
                  <div className="bg-white border border-gray-200 rounded-2xl p-6">
                    ...
                    <div className="border-2 border-dashed rounded-xl p-8 text-center transition-all border-gray-200 bg-secondary hover:border-green-500/50 hover:bg-gray-50">
                      <div className="flex justify-center mb-4">
                        <div className="w-16 h-16 bg-green-500/10 rounded-full flex items-center justify-center">
                          <svg
              ...
              <div className="sticky top-0 bg-white border-b border-gray-200 p-6 flex items-center justify-between">
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-gray-600">
                      {selectedCandidate.experience} of experience
                    </p>
                  </div>
                </div>
                <button
                ...
                <div>
                  ...
                  <div className="p-4 bg-gray-50 rounded-lg">
                    <p className="text-sm text-gray-900 leading-relaxed">
                      {selectedCandidate.professionalAssessment}
                    </p>
                  </div>
                </div>
                  ...
                  <div className="mb-6">
                    <div className="flex items-center justify-between mb-2">
                      ...
                      <span className="text-sm font-semibold text-green-500">
                        {calculateSkillsGap(selectedCandidate)}%
                      </span>
                    </div>
